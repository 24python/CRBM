# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-01 05:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yuding.MeetingRoom', verbose_name='预定房间')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yuding.UserInfo', verbose_name='预订人'),
        ),
